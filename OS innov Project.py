...
#initialisation
nombrePietons = 10; largeurSalle = 5; longueurSalle=5; k=1.2*(10**4)
...
def environnement():
    ...
    plt.scatter(listePorte[0][0]+0.05, listePorte[0][1], color = 'pink', marker='s', edgecolors='r',s=400, label='porte')
...
i=0
while min(coordonnees[:,0])<listePorte[0][0]: #pour s'assurer que tous les piétons ont évacués
    # change passenger position
    ...
    logging.debug(i)
    i=i+1 #pour détérminer le temps d'évacuation: on multiplie i final par h le pas du mouvement.
    if i == 50:
...
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
#traçage de l'evacuation d'une salle avec obstacle (figures 5,6)
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
